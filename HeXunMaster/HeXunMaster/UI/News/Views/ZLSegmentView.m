...
- (void)clickSegmentButton:(UIButton*)selectedButton{
    ...
    if ([_delegate respondsToSelector:@selector(ZLSegmentView:didSelectIndex:)]) {
        [_delegate ZLSegmentView:self didSelectIndex:_selectedIndex];
    }
