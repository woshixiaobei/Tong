...
- (void)drawRect:(CGRect)rect {
    ...
    //背景线
    UIBezierPath *basePath = [UIBezierPath bezierPathWithArcCenter:center radius:radius startAngle:_startAngle endAngle:endA clockwise:NO];
    //线条宽度
    ...
    //路径线
    UIBezierPath *valuePath = [UIBezierPath bezierPathWithArcCenter:center radius:radius startAngle:_startAngle endAngle:valueEndA clockwise:NO];
    //设置线条顶端
    CGContextSetLineCap(ctx, kCGLineCapButt);
    //线条颜色
